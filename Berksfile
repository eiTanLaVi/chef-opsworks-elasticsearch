...
cookbook 'apt', '>= 2.3.8', git: 'git://github.com/opscode-cookbooks/apt.git', tag: 'v2.4.0'
...
cookbook 'build-essential', '>= 1.4.2', git: 'git://github.com/opscode-cookbooks/build-essential.git', tag: 'v2.0.4'
cookbook 'java', '>= 1.19.2', git: 'git://github.com/agileorbit-cookbooks/java.git', tag: 'v1.24.0'
...
cookbook 'rsyslog', '>= 1.11.0', git: 'git://github.com/opscode-cookbooks/rsyslog.git', tag: 'v1.12.2'
cookbook 'windows', '>= 1.30.0', git: 'git://github.com/opscode-cookbooks/windows.git', tag: 'v1.33.1'
cookbook 'yum', git: 'git://github.com/opscode-cookbooks/yum.git', tag: 'v3.2.2'
cookbook 'yum-epel', '>= 0.3.4', git: 'git://github.com/opscode-cookbooks/yum-epel.git', tag: 'v0.4.0'
